...
import { NavigationLocators, TableLocators, FormLocators } from "@src/locators";
...
export class ContactFormPage {
  ...
  async searchFor(searchText: string) {
    ...
    const searchInput = this.page.locator(`${FormLocators.textInput}, ${FormLocators.searchInput}`).filter({ hasText: '' }).last();
